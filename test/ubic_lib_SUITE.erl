...
t_datetime_to_iso8601_test(_) ->
    <<"2012-05-19T22:34:55Z">> =
        ubic_time:datetime_to_iso8601({{2012,5,19},{22,34,55}}),
    <<"2012-11-30T09:01:00.486Z">> =
        ubic_time:datetime_to_iso8601({{{2012,11,30},{9,1,0}},486}).

t_iso8601_to_datetime_test(_) ->
    {{2012,05,19},{22,34,55}} =
        ubic_time:iso8601_to_datetime(<<"2012-05-19T22:34:55Z">>),
    {{{2012,11,30},{9,1,0}},486} =
        ubic_time:iso8601_to_datetime(<<"2012-11-30T09:01:00.486Z">>).

t_gregorian_seconds_to_iso8601_test(_) ->
    GregorianSec =
        calendar:datetime_to_gregorian_seconds({{2012,10,5},{1,10,11}}),
    <<"2012-10-05T01:10:11Z">> =
        ubic_time:gregorian_secs_to_iso8601(GregorianSec).

t_iso8601_to_gregorian_seconds_test(_) ->
    GregorianSec =
        calendar:datetime_to_gregorian_seconds({{1950,2,22},{15,30,14}}),
    GregorianSec =
        ubic_time:iso8601_to_gregorian_secs(<<"1950-02-22T15:30:14Z">>),
...
t_epoch_to_iso8601_test(_) ->
    ...
    ISO8601 = ubic_time:epoch_msecs_to_iso8601(EpochMsecs),
